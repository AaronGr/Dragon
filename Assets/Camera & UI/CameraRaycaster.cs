...
public class CameraRaycaster : MonoBehaviour
{
    ...
    public enum Layers {DefaultLayer, TransparentFXLayer, IgnoreRaycastLayer, Layer3, WaterLayer, UILayer, Layer6, Layer7, EnemyLayer, WalkableLayer};
    ...
    void Update()
	{
		...
		{
			NotifyObserversIfLayerChanged ((int)Layers.UILayer);
		...
		{
			NotifyObserversIfLayerChanged ((int)Layers.DefaultLayer); // broadcast default layer
			return;
		}
